<template>
  ...
  >
    ...
    <van-button class="dl" type="primary" @click="toHome()">找回密码并登陆</van-button>
...
<script>
   import { Dialog,Toast } from 'vant';
    ...
    methods: {
        ...
        axios({
          method:'post',          					url:'http://47.107.138.115:8082/weishan/weishan.weishan/user/authCode.do',  
          params:{phone:this.phone,type:2}
        }).then((data)=>{
		 ...
		 toHome(){
			axios({
				method:'post',
				url:'http://47.107.138.115:8082/weishan/weishan.weishan/user/register.do',
